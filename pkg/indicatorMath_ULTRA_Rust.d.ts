...
export class WasmAnalysisGenerator {
    free(): void;
    [Symbol.dispose](): void;
    append_candle(candle_json: string): any;
    append_tick(price: number, time: bigint): any;
    get_analysis_array(): any;
    get_last_result(): any;
...
export interface InitOutput {
    ...
    readonly wasmanalysisgenerator_append_candle: (a: number, b: number, c: number) => [number, number, number];
    readonly wasmanalysisgenerator_get_last_result: (a: number) => [number, number, number];
    readonly wasmanalysisgenerator_get_analysis_array: (a: number) => [number, number, number];
