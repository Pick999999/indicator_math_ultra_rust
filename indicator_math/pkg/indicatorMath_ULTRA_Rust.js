...
export class WasmAnalysisGenerator {
     ...
     * @returns {any}
     */
    append_candle(candle_json) {
        const ptr0 = passStringToWasm0(candle_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmanalysisgenerator_append_candle(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     */
    get_analysis_array() {
        const ret = wasm.wasmanalysisgenerator_get_analysis_array(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_last_result() {
        const ret = wasm.wasmanalysisgenerator_get_last_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 249, function: Function { arguments: [NamedExternref("GPUUncapturedErrorEvent")], shim_idx: 250, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
